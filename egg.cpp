...
// for menu option
int dropped_eggs=0;
int speed_1 = 2.5, speed_2 = 2, speed_3 = 2.5, speed_4 = 3;
...
void winscreen(){
	...
	glLoadIdentity();
	glColor3f(0.0,1.0,0.0);
	output(55,500,"CONGRATS!!!");
	glColor3f(1.0,0.0,1.0);
	output(55,400,"YOU WON");
	output(35,300,"* PRESS ESC TO GO TO MAIN MENU");
	glFlush();
}
...
void timeover(){
	 ...
	 glLoadIdentity();
	 glColor3f(1.0,0,0);
	 output(70,500,"GAME OVER");
	 glColor3f(0,1,0);
	 output(50,400,"YOU HAVE LOST THE GAME");
	 output(50,300,"BETTER LUCK NEXT TIME");
	 glFlush();
}
...
void frontscreen(void){
	 ...
	 glColor3f(0,0,0);
	 drawstring(150,5," Press ENTER to go To next screen",GLUT_BITMAP_HELVETICA_18);
	 //drawstring(-45,5,"Maximize window for better view",GLUT_BITMAP_HELVETICA_12);
	 glColor3f(1,1,1);
	 output(5,160,"");
	 glColor3f(1,0,0);
	 drawstring(180,600,"SJB Institute of Technology",GLUT_BITMAP_TIMES_ROMAN_24);
	 glColor3f(0,0,0);
	 ...
	 glColor3f(0,1,1);
	 output(160,250,"Pratyush Kumar (1JB19CS101)");
	 output(160,200,"Prathyusha Sajja (1JB19CS100)");
	 //glBegin(GL_LINES);
	 glVertex2f(40,98);
	 glVertex2f(50,98);
	 glEnd();
